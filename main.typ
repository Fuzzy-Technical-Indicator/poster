...
#show: poster.with(
  ...
  authors: "ธนัตถ์ ตั้งอั้น, ธนวัตน์ บําเพ็งพันธ์",
...
ทั้งหมดนี้แต่ละการเข้าซื้อมีขึ้นต่ำอยู่ที่ 30 USD และสำหรับการเข้าซื้อแบบที่ไม่ได้การจัดการเงินทุนจะเข้าซื้อที่ 5% ของเงินที่มีอยู่ขณะนั้น และในการออกจากการเข้าซื้อที่ทำไปแล้วจะใช้วิธีเมื่อกำไรของการเข้าซื้อนั้น $>= 20\%$ สำหรับ Crypto Currecny และ $>= 10\%$ สำหรับหุ้น NASDAQ ก็จะให้ทำการขายเอากำไรเลย (take profit) และเมื่อการเข้าซื้อนั้นขาดทุนมากกว่า $>= 10\%$ สำหรับ Crypto Currency และ $>= 5\%$ สำหรับหุ้ร NASDAQ ก็ให้ทำการขายเพื่อไม่ให้ขาดทุนไปมากกว่านี้เลย (stop loss)

นอกจากนี้เราจะมีวิธี Buy & Hold ซึ่งเป็นวิธีการนี้ก็คือการซื้อ สินทรัพย์ไว้ด้วยจำนวนเงินทั้งหมดตั้งแต่วันแรกที่ทดสอบไว้ แล้วถือไว้โดยไม่ขายออก เป็นตัวไว้เปรียบเทียบ เวลาที่เริ่มทดสอบ คือวันที่ 1 ตุลาคม 2023 เวลา 00:00 (GMT+07) ถึง 24 กุมภาพันธ์ 2024 เวลา 17:50 (GMT+07) เป็นเวลาประมาณ 5 เดือน
...
= สรุปผล
จาก @crypto_g และ @stock_g เราจะเห็นว่าการใช้ Fuzzy Logic มาสร้างอินดิเคเตอร์ใหม่นั้นให้ผลลัพธ์ ที่ดีกว่าการใช้ตัวเลขธรรมดาแบบ Classical เสมอ โดยเฉพาะในตลาด Crypto Currecny ที่จะเห็นว่าแบบ Classical นั้นให้ผลลัพธ์ที่แย่กว่าแบบ Fuzzy อย่างชัดเจน และจะเห็นว่าถ้าเราเปรียบเทียบกับการ Buy & Hold เราจะได้ผลลัพธ์ที่ใกล้เคียงกัน แต่การเปลี่ยนแปลงของเงินทุนนั้นมีความผันผวนกว่า    และมีช่วงที่เงินทุนลดไปเป็นจำนวนมากเยอะ ถ้าเราดูใน @table1 และ @table2 จะเห็นว่าไม่มีวิธีการเข้าซื้อจาก Fuzzy Logic แบบไหนที่ให้ผลลัพธ์นี่ดีกว่าแบบอื่นอย่างเป็นเอกฉันท์ และจะมีบางเหรียญหรือหุ้นที่ Fuzzy กับ Fuzzy PSO ให้ผลเหมือนกันเนื่องจาก PSO นั้นสรุปว่าการไม่เปลี่ยนแปลงตัวแปรทางภาษาเลยให้ผลที่ดีที่สุดแล้วในเวลาที่ใช้ฝึกสอน
